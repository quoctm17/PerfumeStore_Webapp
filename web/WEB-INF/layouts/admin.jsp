        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="sidebar-wrapper">
                ...
                <div class="sidebar-list">
                    <a class="sidebar-item active p-3" href="<c:url value="/admin/dashboard.do" />"><i class="fa-solid fa-gauge"></i>Dashboard</a>
                    ...
                    <c:if test="${sessionScope.acc.role == 'ROLE_ADMIN'}">
                        ...
                        <a class="sidebar-item p-3" href="<c:url value="/admin/revenue/list.do?time=daily" />"><i class="fa-solid fa-money-bill-trend-up"></i>Revenue</a>
